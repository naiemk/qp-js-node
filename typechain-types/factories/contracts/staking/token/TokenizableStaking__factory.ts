...
} from "../../../../contracts/staking/token/TokenizableStaking";
...
export class TokenizableStaking__factory {
  ...
  static createInterface(): TokenizableStakingInterface {
    return new Interface(_abi) as TokenizableStakingInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): TokenizableStaking {
    return new Contract(address, _abi, runner) as unknown as TokenizableStaking;
  }
}
