...
import type {
  PortalLedger,
  PortalLedgerInterface,
} from "../../../../contracts/quantumPortal/poc/PortalLedger";
...
export class PortalLedger__factory {
  static readonly abi = _abi;
  static createInterface(): PortalLedgerInterface {
    return new Interface(_abi) as PortalLedgerInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): PortalLedger {
    return new Contract(address, _abi, runner) as unknown as PortalLedger;
  }
}
