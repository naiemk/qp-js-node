...
export interface WithAdminUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "admin"
      | "owner"
...
export interface WithAdminUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): WithAdminUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: WithAdminUpgradeableInterface;
