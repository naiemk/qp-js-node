...
export interface SweepableUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "admin"
      | "freezeSweep"
...
export interface SweepableUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): SweepableUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: SweepableUpgradeableInterface;
