...
export interface DummyTokenOwnableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface DummyTokenOwnable extends BaseContract {
  connect(runner?: ContractRunner | null): DummyTokenOwnable;
  waitForDeployment(): Promise<this>;

  interface: DummyTokenOwnableInterface;
