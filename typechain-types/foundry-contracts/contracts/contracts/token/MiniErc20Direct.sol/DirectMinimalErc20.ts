...
export interface DirectMinimalErc20Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "_name"
      | "_symbol"
...
export interface DirectMinimalErc20 extends BaseContract {
  connect(runner?: ContractRunner | null): DirectMinimalErc20;
  waitForDeployment(): Promise<this>;

  interface: DirectMinimalErc20Interface;
