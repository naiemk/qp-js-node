...
export interface WFRMInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface WFRM extends BaseContract {
  connect(runner?: ContractRunner | null): WFRM;
  waitForDeployment(): Promise<this>;

  interface: WFRMInterface;
