...
export interface QpErc20TokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface QpErc20Token extends BaseContract {
  connect(runner?: ContractRunner | null): QpErc20Token;
  waitForDeployment(): Promise<this>;

  interface: QpErc20TokenInterface;
