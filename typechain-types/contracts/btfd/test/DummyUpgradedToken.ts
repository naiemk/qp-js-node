...
export interface DummyUpgradedTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface DummyUpgradedToken extends BaseContract {
  connect(runner?: ContractRunner | null): DummyUpgradedToken;
