...
export interface QpMultiSenderInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "admin"
      | "initializeWithQp"
  ...
  getEvent(
    nameOrSignatureOrTopic: "AdminSet" | "Log" | "OwnershipTransferred"
  ): EventFragment;
...
export interface QpMultiSender extends BaseContract {
  connect(runner?: ContractRunner | null): QpMultiSender;
  waitForDeployment(): Promise<this>;

  interface: QpMultiSenderInterface;
  ...
  qpMultiSend: TypedContractMethod<
    [targets: AddressLike[]],
    [void],
    "nonpayable"
  >;
