...
export interface TokenReceivableUpgradeableInterface extends Interface {
  getFunction(nameOrSignature: "inventory" | "syncInventory"): FunctionFragment;
...
export interface TokenReceivableUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): TokenReceivableUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: TokenReceivableUpgradeableInterface;
