...
export interface WithQpUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "admin"
      | "initializeWithQp"
...
export interface WithQpUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): WithQpUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: WithQpUpgradeableInterface;
