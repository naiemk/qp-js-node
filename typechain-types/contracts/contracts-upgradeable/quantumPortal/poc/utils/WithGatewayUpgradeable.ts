...
export interface WithGatewayUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "gateway"
      | "owner"
...
export interface WithGatewayUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): WithGatewayUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: WithGatewayUpgradeableInterface;
