...
export interface QuantumPortalLedgerMgrUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface QuantumPortalLedgerMgrUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): QuantumPortalLedgerMgrUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: QuantumPortalLedgerMgrUpgradeableInterface;
