...
export interface QuantumPortalNativeFeeRepoBasicUpgradeableInterface
  extends Interface {
  getFunction(
    nameOrSignature:
      | "VERSION"
...
export interface QuantumPortalNativeFeeRepoBasicUpgradeable
  ...
  interface: QuantumPortalNativeFeeRepoBasicUpgradeableInterface;
