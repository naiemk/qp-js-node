...
export interface StakeOpenUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "NAME"
...
export interface StakeOpenUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): StakeOpenUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: StakeOpenUpgradeableInterface;
