...
export interface BaseStakingV2UpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "admins"
...
export interface BaseStakingV2Upgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): BaseStakingV2Upgradeable;
  waitForDeployment(): Promise<this>;

  interface: BaseStakingV2UpgradeableInterface;
