...
export interface DirectMinimalErc20_Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "_name"
      | "_symbol"
...
export interface DirectMinimalErc20_ extends BaseContract {
  connect(runner?: ContractRunner | null): DirectMinimalErc20_;
  waitForDeployment(): Promise<this>;

  interface: DirectMinimalErc20_Interface;
  ...
  init: TypedContractMethod<
    [to: AddressLike, name_: string, symbol_: string, supply: BigNumberish],
    [void],
    "nonpayable"
  >;
