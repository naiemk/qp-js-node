...
export interface QuantumPortalLedgerMgrImplUpgradeableInterface
  extends Interface {
  getFunction(
    nameOrSignature:
...
export interface QuantumPortalLedgerMgrImplUpgradeable extends BaseContract {
  connect(
    runner?: ContractRunner | null
  ): QuantumPortalLedgerMgrImplUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: QuantumPortalLedgerMgrImplUpgradeableInterface;
