...
export interface QuantumPortalLedgerMgrImplInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "VERSION"
      | "admin"
...
export interface QuantumPortalLedgerMgrImpl extends BaseContract {
  connect(runner?: ContractRunner | null): QuantumPortalLedgerMgrImpl;
