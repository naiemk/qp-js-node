...
export interface QuantumPortalPocUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface QuantumPortalPocUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): QuantumPortalPocUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: QuantumPortalPocUpgradeableInterface;
