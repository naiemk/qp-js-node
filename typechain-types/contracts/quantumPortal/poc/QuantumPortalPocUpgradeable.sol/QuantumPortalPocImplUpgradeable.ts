...
export interface QuantumPortalPocImplUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface QuantumPortalPocImplUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): QuantumPortalPocImplUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: QuantumPortalPocImplUpgradeableInterface;
