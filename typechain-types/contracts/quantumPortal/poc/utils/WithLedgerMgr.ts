...
export interface WithLedgerMgrInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "admin"
...
export interface WithLedgerMgr extends BaseContract {
  connect(runner?: ContractRunner | null): WithLedgerMgr;
  waitForDeployment(): Promise<this>;

  interface: WithLedgerMgrInterface;
