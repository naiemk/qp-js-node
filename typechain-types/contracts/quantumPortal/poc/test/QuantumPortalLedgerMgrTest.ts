...
export interface QuantumPortalLedgerMgrTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "VERSION"
      | "admin"
...
export interface QuantumPortalLedgerMgrTest extends BaseContract {
  connect(runner?: ContractRunner | null): QuantumPortalLedgerMgrTest;
