...
export interface QuantumPortalPocTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "VERSION"
      | "admin"
...
export interface QuantumPortalPocTest extends BaseContract {
  connect(runner?: ContractRunner | null): QuantumPortalPocTest;
  waitForDeployment(): Promise<this>;

  interface: QuantumPortalPocTestInterface;
