...
export interface QuantumPortalPocUpgradeableTestInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface QuantumPortalPocUpgradeableTest extends BaseContract {
  connect(runner?: ContractRunner | null): QuantumPortalPocUpgradeableTest;
  waitForDeployment(): Promise<this>;

  interface: QuantumPortalPocUpgradeableTestInterface;
