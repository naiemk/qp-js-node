...
export interface PortalLedgerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "admin"
      | "clearContext"
...
export interface PortalLedger extends BaseContract {
  connect(runner?: ContractRunner | null): PortalLedger;
