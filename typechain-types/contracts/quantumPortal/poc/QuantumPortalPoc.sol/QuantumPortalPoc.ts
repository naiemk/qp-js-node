...
export interface QuantumPortalPocInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "VERSION"
      | "admin"
...
export interface QuantumPortalPoc extends BaseContract {
  connect(runner?: ContractRunner | null): QuantumPortalPoc;
