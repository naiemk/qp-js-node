...
export interface MitlChainToken2MasterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CHAIN_ID"
      | "TOTAL_SUPPLY"
...
export interface MitlChainToken2Master extends BaseContract {
  connect(runner?: ContractRunner | null): MitlChainToken2Master;
