...
export interface MitlChainToken2ClientInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CHAIN_ID"
      | "MASTER_CHAIN_ID"
...
export interface MitlChainToken2Client extends BaseContract {
  connect(runner?: ContractRunner | null): MitlChainToken2Client;
