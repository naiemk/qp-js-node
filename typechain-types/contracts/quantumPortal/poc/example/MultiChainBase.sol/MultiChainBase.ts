...
export interface MultiChainBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CHAIN_ID"
      | "owner"
...
export interface MultiChainBase extends BaseContract {
  connect(runner?: ContractRunner | null): MultiChainBase;
  waitForDeployment(): Promise<this>;

  interface: MultiChainBaseInterface;
