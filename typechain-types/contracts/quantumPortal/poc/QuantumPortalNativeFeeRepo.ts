...
export interface QuantumPortalNativeFeeRepoInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "VERSION"
      | "admin"
...
export interface QuantumPortalNativeFeeRepo extends BaseContract {
  connect(runner?: ContractRunner | null): QuantumPortalNativeFeeRepo;
  ...
  init: TypedContractMethod<
    [_portal: AddressLike, _feeConvertor: AddressLike],
    [void],
    "nonpayable"
  >;
