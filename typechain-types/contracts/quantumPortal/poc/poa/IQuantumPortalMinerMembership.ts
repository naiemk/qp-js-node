...
export interface IQuantumPortalMinerMembershipInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "findMiner"
      | "findMinerAtTime"
...
export interface IQuantumPortalMinerMembership extends BaseContract {
  connect(runner?: ContractRunner | null): IQuantumPortalMinerMembership;
