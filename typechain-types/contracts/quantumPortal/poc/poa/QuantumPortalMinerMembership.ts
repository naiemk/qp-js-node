...
export interface QuantumPortalMinerMembershipInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "findMiner"
      | "findMinerAtTime"
...
export interface QuantumPortalMinerMembership extends BaseContract {
  connect(runner?: ContractRunner | null): QuantumPortalMinerMembership;
