...
export interface QuantumPortalAuthorityMgrInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface QuantumPortalAuthorityMgr extends BaseContract {
  connect(runner?: ContractRunner | null): QuantumPortalAuthorityMgr;
