...
export interface QuantumPortalFeeConverterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "VERSION"
      | "admin"
...
export interface QuantumPortalFeeConverter extends BaseContract {
  connect(runner?: ContractRunner | null): QuantumPortalFeeConverter;
