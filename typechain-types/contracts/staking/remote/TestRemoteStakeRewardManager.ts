...
export interface TestRemoteStakeRewardManagerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addReward"
      | "addRewardPublic"
...
export interface TestRemoteStakeRewardManager extends BaseContract {
  connect(runner?: ContractRunner | null): TestRemoteStakeRewardManager;
