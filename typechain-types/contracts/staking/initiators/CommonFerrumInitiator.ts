...
export interface CommonFerrumInitiatorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "admins"
...
export interface CommonFerrumInitiator extends BaseContract {
  connect(runner?: ContractRunner | null): CommonFerrumInitiator;
  ...
  openEnded: TypedContractMethod<
    [
      ...
      feeTarget: AddressLike,
      allowedRewardTokens: AddressLike[],
      tokenizable: boolean,
  ...
  publicStaking: TypedContractMethod<
    [
      id: AddressLike,
      name: string,
      baseToken: AddressLike,
  ...
  signatureByIdSignerAddress: TypedContractMethod<
    [
      id: AddressLike,
  ...
  >;
  getFunction(
    nameOrSignature: "signatureByIdSignerAddress"
  ): TypedContractMethod<
    [
      id: AddressLike,
      stakeType: BigNumberish,
